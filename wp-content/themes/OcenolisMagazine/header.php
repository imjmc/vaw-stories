...
Cufon.replace('h1',{hover: true})('h2',{hover: true})('h3',{hover: true})('h4:not(.feat-cat-meta h4)',{hover: true})('h5',{hover: true})('h6',{hover: true})('#top li a',{hover: true})('.description',{hover: true});
});
</script>
</head>
<body>
 ...
 <div id="top"><!-- PAGE MENU, OR PRIMARY CUSTOM MENU -->
	...
	?>
        <ul class="sf-menu">
        	...
        	<?php wp_list_pages("sort_column=menu_order&depth=3&exclude=$ex;&title_li=&depth=1");?>
    	</ul>
    <?php } ?>
  </div><!-- END PAGE MENU -->
<div id="mainwrap">